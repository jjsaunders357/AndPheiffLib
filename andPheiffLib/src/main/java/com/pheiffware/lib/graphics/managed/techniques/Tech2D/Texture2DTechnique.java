...
public class Texture2DTechnique extends ProgramTechnique
{
    ...
    public Texture2DTechnique(GLCache glCache) throws GraphicsException, IOException, ParseException
    {
        super(glCache, new RenderProperty[]{RenderProperty.PROJECTION_MATRIX, RenderProperty.VIEW_MATRIX}, "2d/vert_2d_texture_pos4.glsl", "2d/frag_2d_texture_pos4.glsl");
    }
