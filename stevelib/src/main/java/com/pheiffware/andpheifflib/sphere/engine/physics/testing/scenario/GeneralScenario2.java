 ...
 *
 */
public class GeneralScenario2 extends PhysicsScenario
{
	public GeneralScenario2(float scenarioRuntime)
	{
	...
	public void setup(PhysicsSystem physicsSystem)
	{
		...
		SphereEntity circle2 = new SphereEntity(new Vec3F(0, 500, 0), new Vec3F(250, -80, 0), 25, 0.85f, 40);
		physicsSystem.addEntity(circle2);
		physicsSystem.addEntity(new SphereEntity(new Vec3F(200, 400, 0), new Vec3F(0, 0, 0), 5, 0.85f, 20));
		physicsSystem.addEntity(new SphereEntity(new Vec3F(250, 400, 0), new Vec3F(0, 0, 0), 5, 0.85f, 20));
		physicsSystem.addEntity(new SphereEntity(new Vec3F(300, 400, 0), new Vec3F(0, 0, 0), 5, 0.85f, 20));
		physicsSystem.addEntity(new SphereEntity(new Vec3F(350, 400, 0), new Vec3F(0, 0, 0), 5, 0.85f, 20));
		...
		physicsSystem.addEntity(new DirectionalGravityEntity(new Vec3F(600, 600, 0)));
	}
