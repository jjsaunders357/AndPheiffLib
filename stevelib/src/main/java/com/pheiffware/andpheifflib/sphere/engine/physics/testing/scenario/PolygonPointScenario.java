...
public class PolygonPointScenario extends PhysicsScenario
{
	...
	{
		SphereEntity circle1 = new SphereEntity(new Vec3F(400, 200, 0), new Vec3F(0, 0, 0), 25, 1.0f, 50);
		...
		//@formatter:on
		PolygonWallEntity polygon = new PolygonWallEntity(new Vec3F(0, 0, 0), 1.0f, points);
		physicsSystem.addEntity(polygon);
		physicsSystem.addEntity(new WallEntity(new Vec3F(0, 700, 0), new Vec3F(700, 700, 0), -1, new Vec3F(0, 0, 0), 1.0f));
