...
*/
package com.pheiffware.andpheifflib.examples.andGraphics;
...
import com.pheiffware.andpheifflib.graphics.GLUtils;
import com.pheiffware.andpheifflib.graphics.GraphicsException;
import com.pheiffware.andpheifflib.graphics.ImageUtils;
import com.pheiffware.andpheifflib.graphics.buffer.CombinedVertexBuffer;
import com.pheiffware.andpheifflib.graphics.buffer.PrimitiveIndexBuffer;
import com.pheiffware.andpheifflib.graphics.program.Program;
import com.pheiffware.andpheifflib.graphics.program.Shader;
import com.pheiffware.andpheifflib.fatalError.FatalErrorHandler;
...
public class TestRenderer1 implements Renderer
{
	...
	public void onSurfaceChanged(GL10 gl, int width, int height)
	{
		...
		projectionMatrix = GLUtils.generateProjectionMatrix(60.0f, width / (float) height, 1, 10, false);
	}
