...
public interface ElementObjectFactory<T>
{
     ...
     * @throws XMLParseException throw if this element is actually misformatted (rather than something you simply want to ignore).
     */
    T createFromElement(Element element) throws XMLParseException;
}
